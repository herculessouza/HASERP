...
type
  TServicesCadastro = class(TDataModule)
    ...
    Qry_PessoasPES_ENDERECO: TStringField;
    ...
    qry_produto1PR1_CODBAR: TStringField;
    ...
    qry_produto2PR2_STRIBUTARIA: TIntegerField;
...
var
  ServicesCadastro: TServicesCadastro;
