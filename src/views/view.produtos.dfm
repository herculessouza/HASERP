inherited viewProdutos: TviewProdutos
          ...
          object DBG_Detalhes: TDBGrid
            ...
            Columns = <
              ...
              item
                ...
                Title.Caption = 'SITUA'#199#195'O TRIBUTARIA'
                Width = 152
                Visible = True
              end
              item
  ...
  object pnlTituloCadproduto: TPanel [3]
    Left = 0
    Top = 35
    Width = 1024
    Height = 54
  ...
  inherited dsDados: TDataSource
    DataSet = ServicesCadastro.qry_produto1
    Left = 697
  end
  object dsProdutos2: TDataSource
    DataSet = ServicesCadastro.qry_produto2
    Left = 697
    Top = 283
  end
end
